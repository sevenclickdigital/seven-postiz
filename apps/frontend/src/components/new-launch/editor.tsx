      ...
      {!canEdit && !isCreateSet && (
        <>
          ...
          >
            ...
            <div>
              <div className="text-white rounded-[8px] h-[44px] px-[20px] bg-[#00C0C1] cursor-pointer flex justify-center items-center">
                        ...
                        {!!internal && !existingData?.integration && (
                          ...
                          >
                            <div className="flex gap-[6px] items-center">
                              <div className="w-[8px] h-[8px] rounded-full bg-[#E891DC]" />
